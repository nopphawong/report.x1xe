...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="text-center fw-light">Registrations</h1>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="search" class="form-control" placeholder="Search by Username, Name, Tel or Code" v-model="filter" @input="filter_user">
                            </div>
                        </div>
                    </div>
                    <div class="card-body table-responsive">
                        <template v-if="table.filtered.length">
                            <Datatable class="table table-striped" :value="table.filtered" :size="`small`" paginator :rows="rows.perpage">
                                ...
                                <Column field="amt_1" header="First Deposit" sortable>
                                    <template #body="{data}">
                                        {{ formatCurrency(data.amt_1) }}
                                    </template>
                                </Column>
        ...
        methods: {
            async list() {
                ...
                let {
                    ...
                    message,
                    data
                } = await post(`report/registerlistsbydate`, this.form)
                this.loading = false
